...
static inline uint8_t* twi_masterBuffer() {return WireBuffers::instance().twi_masterBuffer();}
static inline size_t twi_masterBufferCapacity() {return WireBuffers::instance().twi_masterBufferCapacity();}


static volatile uint8_t twi_txBufferIndex;
static volatile uint8_t twi_txBufferLength;
static inline uint8_t* twi_txBuffer() {return WireBuffers::instance().twi_txBuffer();}
static inline size_t twi_txBufferCapacity() {return WireBuffers::instance().twi_txBufferCapacity();}

static volatile uint8_t twi_rxBufferIndex;
static inline uint8_t* twi_rxBuffer() {return WireBuffers::instance().twi_rxBuffer();}
static inline size_t twi_rxBufferCapacity() {return WireBuffers::instance().twi_rxBufferCapacity();}
