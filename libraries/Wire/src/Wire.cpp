...
uint8_t* TwoWire::rxBuffer() {
  return WireBuffers::instance().rxWireBuffer();
}

size_t TwoWire::rxBufferCapacity() {
  return WireBuffers::instance().rxWireBufferCapacity();
}

uint8_t* TwoWire::txBuffer() {
  return WireBuffers::instance().txWireBuffer();
}

size_t TwoWire::txBufferCapacity() {
  return WireBuffers::instance().txWireBufferCapacity();
}
